...
(function(vue, shared) {
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/components/diy-noticebar/diy-noticebar.vue"]]);
  const BASE_API_URL = "http://localhost:8000";
  const SHARE_URL = BASE_API_URL + "/usr-service/share";
  ...
  const _sfc_main$8 = {
    ...
    methods: {
      ...
      async getNoticeList() {
        const res2 = await request(LATEST_NOTICE_URL, "GET");
        this.message = res2.data.content;
        formatAppLog("log", "at pages/index.vue:143", res2);
      },
      changeTabs(evt) {
  ...
  function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25487" }, [
      vue.createElementVNode("view", { class: "flex diygw-col-24 flex-direction-column" }, [
        ...
        vue.createElementVNode("view", { class: "" }, [
              ...
              vue.createElementVNode("view", { class: "flex diygw-col-6" }, [
                vue.createElementVNode("view", { class: "diygw-avatar radius bg-none" }, [
                  vue.createElementVNode("image", {
                    ...
                    src: "/static/OpenAI-ChatGPT-New-chatbots-examples-limitations-and-more-6-1536x1009.jpg"
                  })
                ])
              ]),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 text-clz" }, " ChatGpt辅助开发React项目 "),
                vue.createElementVNode("view", { class: "diygw-text-line2 diygw-col-24" }, " ChatGpt辅助开发React项目ChatGpt辅助开发React项目ChatGpt辅助开发React项目ChatGpt辅助开发React项目 ")
              ]),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-6 flex-direction-column justify-center flex2-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 text2-clz" }, " 10积分 "),
                vue.createElementVNode("view", { class: "diygw-col-24" }, " 下载 ")
              ])
            ]),
            vue.createElementVNode("view", { class: "flex diygw-col-24 flex-nowrap flex3-clz" }, [
              vue.createElementVNode("view", { class: "flex diygw-col-6" }, [
                vue.createElementVNode("view", { class: "diygw-avatar radius bg-none" }, [
                  vue.createElementVNode("image", {
                    mode: "aspectFit",
                    class: "diygw-avatar-img radius",
                    src: "/static/7-201024142630228.jpg"
                  })
                ])
              ]),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 text4-clz" }, " ChatGpt辅助开发React项目 "),
                vue.createElementVNode("view", { class: "diygw-text-line2 diygw-col-24" }, " ChatGpt辅助开发React项目ChatGpt辅助开发React项目ChatGpt辅助开发React项目ChatGpt辅助开发React项目 ")
              ]),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-6 flex-direction-column justify-center flex5-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 text6-clz" }, " 5积分 "),
                vue.createElementVNode("view", { class: "diygw-col-24" }, " 兑换 ")
              ])
            ])
          ])) : vue.createCommentVNode("v-if", true),
          $data.tabsIndex == 1 ? (vue.openBlock(), vue.createElementBlock("view", {
            ...
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column items-end flex6-clz" }, [
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center items-end flex7-clz" }, [
                vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-0 flex-direction-column flex8-clz" }, [
                  vue.createElementVNode("view", { class: "diygw-col-0 text8-clz" }),
                  vue.createElementVNode("view", { class: "diygw-col-0" }, " 积分获取方式 ")
                ])
              ]),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex10-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 text12-clz" }, " 每日签到 "),
                vue.createElementVNode("view", { class: "diygw-col-24 text13-clz" }, " 投稿 ")
              ])
            ]),
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column items-end flex14-clz" }, [
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center items-end flex15-clz" }, [
                vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-0 flex-direction-column flex16-clz" }, [
                  vue.createElementVNode("view", { class: "diygw-col-0 text16-clz" }),
                  vue.createElementVNode("view", { class: "diygw-col-0" }, " 深入交流 ")
                ])
              ]),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex17-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 text18-clz" }, " 技术交流QQ群：8888888 "),
                vue.createElementVNode("view", { class: "diygw-col-24 text19-clz" }, " 私人微信：one15569512930 ")
              ])
            ]),
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column items-end flex9-clz" }, [
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center items-end flex11-clz" }, [
                vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-0 flex-direction-column flex12-clz" }, [
                  vue.createElementVNode("view", { class: "diygw-col-0 text10-clz" }),
                  vue.createElementVNode("view", { class: "diygw-col-0" }, " 公众号(技术分享) ")
                ])
              ]),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex13-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 text14-clz" }, " 点击右上角 => dong技术分享 =>公众号 "),
                vue.createElementVNode("view", { class: "diygw-col-24 text15-clz" }, " 公众号微信：6666 ")
              ])
            ])
          ])) : vue.createCommentVNode("v-if", true)
        ])
  ...
  const PagesIndex = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-02281a80"], ["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/pages/index.vue"]]);
  const _sfc_main$7 = {
    data() {
      return {
        //用户全局信息
  ...
  function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25487" }, [
      vue.createElementVNode("view", { class: "version text-grey flex-direction-column flex diygw-col-24 justify-center align-center" }, [
        vue.createElementVNode("view", null, " DIY官网代码生成器生成 "),
        vue.createElementVNode("view", null, " http://www.diygw.com ")
      ]),
      vue.createElementVNode("view", { class: "clearfix" })
    ]);
  }
  const PagesContributeContribute = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-43f66588"], ["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/pages/contribute/contribute.vue"]]);
  const _sfc_main$6 = {
    data() {
      return {
        //用户全局信息
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25487" }, [
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column justify-center flex-clz" }, [
        vue.createElementVNode("view", { class: "flex diygw-col-24 justify-center" }, [
          vue.createElementVNode("view", { class: "diygw-avatar avatar-avatar xl radius diygw-shadow bg-none" }, [
            vue.createElementVNode("image", {
              mode: "aspectFit",
              class: "diygw-avatar-img radius",
        ...
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column justify-center items-center" }, [
          vue.createElementVNode("view", { class: "diygw-col-3 text-clz" }, " 阿航 "),
          vue.createElementVNode("view", { class: "diygw-col-4 text1-clz" }, " 积分:600 "),
      ...
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column" }, [
        vue.createElementVNode("view", { class: "flex diygw-col-24 items-center flex-nowrap flex4-clz" }, [
          vue.createElementVNode("view", { class: "diygw-col-0 text2-clz" }, " 我的兑换 "),
        ...
        vue.createElementVNode("view", { class: "flex diygw-col-24 items-center flex-nowrap flex5-clz" }, [
          vue.createElementVNode("view", { class: "diygw-col-0 text3-clz" }, " 积分明细 "),
        ...
        vue.createElementVNode("view", { class: "flex diygw-col-24 items-center flex-nowrap flex6-clz" }, [
          vue.createElementVNode("view", { class: "diygw-col-0 text5-clz" }, " 我的投稿 "),
          vue.createElementVNode("text", { class: "flex icon4 diygw-col-0 icon4-clz diy-icon-right" })
        ]),
        vue.createElementVNode("view", { class: "flex diygw-col-24 items-center flex-nowrap flex7-clz" }, [
          vue.createElementVNode("view", { class: "diygw-col-0 text4-clz" }, " 审核投稿 "),
          vue.createElementVNode("text", { class: "flex icon1 diygw-col-0 icon1-clz diy-icon-right" })
        ])
      ]),
      vue.createElementVNode("view", { class: "version text-grey flex-direction-column flex diygw-col-24 justify-center align-center" }, [
        vue.createElementVNode("view", null, " DIY官网代码生成器生成 "),
  ...
  const PagesMyMy = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-2f1ef635"], ["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/pages/my/my.vue"]]);
  const _sfc_main$5 = {
    name: "u-icon",
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-305117c1"], ["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/uni_modules/diy-uview-ui/components/u-icon/u-icon.vue"]]);
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-42f09606"], ["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/uni_modules/diy-uview-ui/components/u-input/u-input.vue"]]);
  function _extends() {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-e2d0cb75"], ["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/uni_modules/diy-uview-ui/components/u-form-item/u-form-item.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {
        //用户全局信息
        ...
        //自定义全局变量
        globalData: {},
        field20afae8981bfFocus: false,
        field20afae8981bf: "",
        field908234b90885Focus: false,
        field908234b90885: ""
      };
    },
    onShow() {
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25487" }, [
      vue.createElementVNode("view", { class: "flex diygw-col-24 flex-direction-column justify-center items-center flex-nowrap flex-clz" }, [
        vue.createElementVNode("view", { class: "flex diygw-col-0" }, [
          vue.createElementVNode("view", { class: "diygw-avatar lg radius diygw-shadow bg-none" }, [
            vue.createElementVNode("image", {
              mode: "aspectFit",
              class: "diygw-avatar-img radius",
      ...
      vue.createElementVNode("view", { class: "diygw-col-24 logintitle-clz diygw-text-lg text-purple" }, " 登录 "),
      vue.createVNode(_component_u_form_item, {
        class: "diygw-col-24 -clz diygw-form-item-small",
        labelPosition: "top",
        prop: "field20afae8981bf"
      }, {
        default: vue.withCtx(() => [
          vue.createElementVNode("text", {
            class: "diy-icon-my margin-right-xs",
            style: { "color": "", "font-size": "16px" }
          }),
          vue.createVNode(_component_u_input, {
            focus: $data.field20afae8981bfFocus,
            class: "",
            placeholder: "请输入手机号",
            modelValue: $data.field20afae8981bf,
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.field20afae8981bf = $event),
            type: "text"
      ...
      vue.createVNode(_component_u_form_item, {
        class: "diygw-col-24 -clz diygw-form-item-small",
        labelPosition: "top",
        prop: "field908234b90885"
      }, {
        default: vue.withCtx(() => [
          vue.createElementVNode("text", {
            class: "diy-icon-lock margin-right-xs",
            style: { "color": "", "font-size": "16px" }
          }),
          vue.createVNode(_component_u_input, {
            focus: $data.field908234b90885Focus,
            class: "",
            placeholder: "请输入密码",
            modelValue: $data.field908234b90885,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.field908234b90885 = $event),
            type: "text"
          }, null, 8, ["focus", "modelValue"])
        ]),
        _: 1
      ...
      vue.createElementVNode("view", { class: "flex diygw-col-24 button-clz" }, [
        vue.createElementVNode("button", {
          ...
          "data-type": "page",
          "data-url": "/pages/my/my",
          class: "diygw-btn red md radius flex-sub margin-xs button-button-clz"
        }, "点击登录")
      ]),
      vue.createElementVNode("view", { class: "version text-grey flex-direction-column flex diygw-col-24 justify-center align-center" }, [
        vue.createElementVNode("view", null, " DIY官网代码生成器生成 "),
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-e4e4508d"], ["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/pages/login/login.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        url: ""
  ...
  const PagesWebview = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/pages/webview.vue"]]);
  ...
  const _sfc_main = {
    globalData: {
      userInfo: null,
      tabBar: ["/pages/index", "/pages/contribute/contribute", "/pages/my/my"],
      homePage: "/pages/index",
      pages: ["/pages/index", "/pages/contribute/contribute", "/pages/my/my", "/pages/login/login"],
      userData: {}
    }
  };
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/15598/Desktop/uniapp-share-app (2)/App.vue"]]);
